                ...
                <nav class="hidden md:flex items-center gap-1">
                    @php
                        ...
                        $navItems = [
                            ...
                            ['route' => 'plan.index', 'perm' => 'portfolio', 'label' => 'แผน DCA', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z M3 21h18'],
                ...
                <div class="relative" id="userMenu">
                    <button type="button" data-user-menu-toggle
                        ...
                        <div class="w-7 h-7 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-xs font-semibold">
                            {{ mb_substr($user->nickname ?: 'ผู้ใช้', 0, 1) }}
                        </div>
                        <span class="text-sm font-medium text-slate-700 hidden sm:inline">{{ $user->nickname ?: 'ผู้ใช้' }}</span>
                    ...
                    <div data-user-menu-panel
                        ...
                        <div class="px-4 py-2 border-b border-slate-100">
                            <p class="text-sm font-medium text-slate-800 truncate">{{ $user->nickname ?: 'ผู้ใช้' }}</p>
